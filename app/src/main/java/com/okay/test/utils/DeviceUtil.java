...
import com.okay.test.MyApplication;
...
public class DeviceUtil {
    ...
    public static String getIccId(){
        TelephonyManager manager = (TelephonyManager)MyApplication.application.getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
