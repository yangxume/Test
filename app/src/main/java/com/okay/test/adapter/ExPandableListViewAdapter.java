...
public class ExPandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int arg0, int arg1, boolean arg2, View arg3, ViewGroup arg4) {
        ...
        if (arg3 == null) {
            ...
            // 获取子视图的布局文件
            arg3 = mInflater.inflate(R.layout.activity_expand_children, arg4, false);
    ...
    public View getGroupView(int arg0, boolean arg1, View arg2, ViewGroup arg3) {
        ...
        if (arg2 == null) {
            ...
            arg2 = mInflater.inflate(R.layout.activity_expand_father, arg3, false);
        ...
        // 一级列表右侧判断箭头显示方向
        if (arg1) {
            hodlerViewFather.group_state.setImageResource(R.mipmap.icon_arrow_down);
        } else {
            hodlerViewFather.group_state.setImageResource(R.mipmap.icon_arrow_up);
        }
        /**
         * 设置相应控件的内容
         */
