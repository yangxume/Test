...
public class ReportTextCircleView extends View {

    private Paint mPaint;

    public ReportTextCircleView(Context context) {
        super(context);
    }
     ...
     * @param attrs
     */
    public ReportTextCircleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
     ...
     * @param defStyle
     */
    public ReportTextCircleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
         ...
         * 如果设置的padding不一样绘制出来的是椭圆形。绘制的时候考虑padding
          */
        Log.d("边界", "宽度"+getMeasuredWidth()+"高度"+getMeasuredHeight()
