...
import com.xy.androidsurvey.bean.Answer;
import com.xy.androidsurvey.bean.Page;
import com.xy.androidsurvey.bean.Quesition;
...
public class Survey1Activity extends AppCompatActivity {
    ...
    private void initView(Page page) {
        ...
        for(int i=0;i<the_quesition_list.size();i++){
            que_view=xInflater.inflate(R.layout.layout_survey1_quesition, null);
            ...
            for(int j=0;j<the_answer_list.size();j++){
                ans_view=xInflater.inflate(R.layout.layout_survey1_answer, null);
                ...
                //判断单选多选加载不同选项图片
                if(the_quesition_list.get(i).getType().equals("1")){
                    image.setBackgroundDrawable(getResources().getDrawable(R.mipmap.rb_item_unselect));
                }else{
                    image.setBackgroundDrawable(getResources().getDrawable(R.mipmap.rb_item_unselect));
                }
                Log.e("---", "------"+image);
...
//                    imglist.get(i).get(j).setBackgroundDrawable(getResources().getDrawable(R.drawable.multiselect_true));
                    imglist.get(i).get(j).setBackgroundDrawable(getResources().getDrawable(R.mipmap.rb_item_unselect));
...
//                    imglist.get(i).get(j).setBackgroundDrawable(getResources().getDrawable(R.drawable.multiselect_false));
                    imglist.get(i).get(j).setBackgroundDrawable(getResources().getDrawable(R.mipmap.rb_item_select));
                ...
                for(int z=0;z<the_answer_lists.size();z++){
                    ...
                    imglist.get(i).get(z).setBackgroundDrawable(getResources().getDrawable(R.mipmap.rb_item_unselect));
                }
                if(the_answer_lists.get(j).getAns_state()==0){
                    //如果当前未被选中
                    imglist.get(i).get(j).setBackgroundDrawable(getResources().getDrawable(R.mipmap.rb_item_unselect));
