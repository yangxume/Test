...
//
////        return DeviceId.getDeviceID(getCtx().getApplicationContext());
//    }
...
//        IMSI = telephonyManager.getSubscriberId();
    ...
    public static String getVersionName() {
        try {
            PackageInfo pi = getCtx().getApplicationContext().getPackageManager()
                    .getPackageInfo(getCtx().getApplicationContext().getPackageName(), 0);
    ...
    public static String getPackageName() {
        return getCtx().getApplicationContext().getPackageName();
    }
    ...
    public static boolean isServiceRunning(String className) {
        ...
        ActivityManager manager = (ActivityManager) getCtx().getApplicationContext().getSystemService(
...
//        TelephonyManager manager = (TelephonyManager) getCtx().getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
//
//        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
//            // TODO: Consider calling
//            //    ActivityCompat#requestPermissions
