package okay.test.timeline.view;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStartLine = typedArray.getDrawable(R.styleable.timeline_style_beginLine);
        mEndLine = typedArray.getDrawable(R.styleable.timeline_style_endLine);
...
//            mMarker = mContext.getResources().getDrawable(R.drawable.marker);
            mMarker = ContextCompat.getDrawable(mContext, R.drawable.marker);
        }
