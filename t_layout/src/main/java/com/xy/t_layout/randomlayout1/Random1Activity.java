 ...
 */
public class Random1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_05_randomlayout);
        ...
        flyLayout.setOnFlyEverythingListener(new FlyLayout.OnFlyEverythingListener() {
            ...
            public void onItemClick(View view, int position, String text) {
                Toast.makeText(Random1Activity.this, text, Toast.LENGTH_SHORT).show();
            }
