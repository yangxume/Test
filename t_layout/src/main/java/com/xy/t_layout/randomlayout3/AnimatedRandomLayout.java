...
import com.xy.t_layout.util.LogUtil;
...
//参数声明/**************************************************************************************/
     ...
     * 记录动画最长持续时间 ，默认为 2000
     */
    private int mDefaultDruation = 100;
    /**
...
//        textView.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.shape_circle_bg_white_touming));
...
/*	@Override
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.e(TAG, "onLayout: childNum = " + childNum);
